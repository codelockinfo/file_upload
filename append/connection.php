...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    ...
    define('MAIN_URL', 'http://localhost/file_upload');
    define('CLS_SITE_URL', 'http://localhost/file_upload');
    define('SITE_CLIENT_URL', 'http://localhost/file_upload/user/');
    define('CLS_TRACK_PATH', $_SERVER['DOCUMENT_ROOT']);
    define('SITE_ADMIN_URL', 'http://localhost/file_upload/admin/');
}elseif ($_SERVER['SERVER_NAME'] == 'codelocksolutions.com') {
    define("DB_SERVER", "localhost");
    define("DB_DATABASE", "u402017191_file_upload");
    define("DB_USERNAME", "u402017191_file_upload");
    define("DB_PASSWORD", "Codelock@99");
    define("DB_OBJECT", "mysql");
    define('MODE', 'live');
    define('ABS_PATH', dirname(dirname(__FILE__)));
    define('MAIN_URL', 'https://codelocksolutions.com/file_upload/');
    define('CLS_SITE_URL', 'https://codelocksolutions.com/file_upload/');
     define('CLS_TRACK_PATH', $_SERVER['DOCUMENT_ROOT']);
    define('SITE_CLIENT_URL', 'https://codelocksolutions.com/file_upload/user/');
    define('SITE_ADMIN_URL', 'https://codelocksolutions.com/file_upload/admin/');
} else {
    echo 'Undefine host';
    exit;
}
...
function  generate_log($inventory = 'General', $log_information = 'test') {
    ...
    if (MODE == 'live') {
       $log_filled_track = CLS_TRACK_PATH.'/file_upload/logs/'. $inventory . '/'. date('Y-m-d') . ".txt";
